	...
	return (
		<section className="mx-auto w-full max-w-5xl relative">
			...
			<div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-30 px-6">
				...
				<h1
					className={cn(
						"fade-in slide-in-from-bottom-10 animate-in text-balance fill-mode-backwards text-center text-5xl font-extrabold tracking-tight delay-100 duration-500 ease-out md:text-6xl lg:text-7xl text-white",
