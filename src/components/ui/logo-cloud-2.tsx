...
export function LogoCloud({ className, ...props }: LogoCloudProps) {
  return (
    ...
    >
      ...
      >
        <PlusIcon
          className="-right-[12.5px] -bottom-[12.5px] absolute z-10 size-6 text-white/10"
          strokeWidth={1}
        />
      </LogoCard>
      ...
      >
        ...
        />
        <PlusIcon
          className="-bottom-[12.5px] -left-[12.5px] absolute z-10 hidden size-6 md:block text-white/10"
          strokeWidth={1}
        />
      </LogoCard>
      ...
      >
        <PlusIcon
          className="-right-[12.5px] -bottom-[12.5px] md:-left-[12.5px] absolute z-10 size-6 md:hidden text-white/10"
          strokeWidth={1}
        />
      </LogoCard>
