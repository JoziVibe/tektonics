  ...
  return (
    <>
      ...
      <div className="space-y-16">
        <section>
          <h2 className="text-3xl font-bold text-white font-headline mb-6">Why Environmental Monitoring?</h2>
        ...
        <div className="mt-20 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl p-8 md:p-16 text-center border border-white/10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 font-headline">Protect your infrastructure before conditions become crises.</h2>
            <Link href="/#contact">
